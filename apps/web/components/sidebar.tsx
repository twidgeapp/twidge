...
const Separator = () => <div className="w-3/4 border-b border-b-text/10 h-[1px]"/>;
...
const Sidebar = (props: Props) => {
    ...
    return (
        <SpaceContext.Provider value={{space: currentSpace}}>
            <div
                className="flex flex-col min-w-[56px] max-w-[56px] w-14 h-full bg-app-sidebar-background items-center py-3 gap-2 border-r border-r-text/10">
                <Link href="/">
