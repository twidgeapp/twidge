...
export const checkIfImage = (file_type: string) =>
    file_type === "png" ||
    file_type === "jpeg" ||
    file_type === "jpg" ||
    file_type === "gif" ||
...
export const checkIfVideo = (file_type: string) =>
    file_type === "mp4" ||
    file_type === "webm" ||
    file_type === "ogg" ||
    file_type === "avi" ||
...
export const checkIfAudio = (file_type: string) =>
    file_type === "mp3" ||
    file_type === "wav" ||
    file_type === "ogg" ||
    file_type === "flac" ||
...
export const checkIfMedia = (file_type: string) =>
    checkIfImage(file_type) || checkIfVideo(file_type);

const Text = ({ element }: { element: WhiteboardItem }) => {
    return <div className="text-white text-sm">{element.value}</div>;
};
    ...
    if (element.item_type === "text") {
        ...
        return (
            <img
                ...
                src={convertFileSrc(element.value)}
            />
        );
        ...
        return <AudioPlayer element={element} />;
    }
