        ...
        <OnBoardingLayout page="3">
            <div className="flex items-center justify-center flex-col gap-2">
                ...
                <p className="text-center text-[15px] opacity-60 pt-5">
                    Elements are the building blocks of Twidge. You can insert
                    an element either by using the
                    <br /> user-interface, or by pasting something into the app.
                    You can also use the global
                    <br />
                    command handler to insert elements. Elements can be text,
                    code, files, todo-lists and more
                </p>
            </div>
            <BottomRightLogo />
            <NextButton page="4" />
