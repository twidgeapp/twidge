...
export interface CreateSpaceArgs { icon: string, color: string, name: string, description: string, accent_color: string, primary_color: string }
...
export interface Space { id: number, name: string, icon: string, color: string, description: string, primaryColor: string, accentColor: string, created_at: string, updated_at: string }
