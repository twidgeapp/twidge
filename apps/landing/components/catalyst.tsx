	...
	return (
		<div className="w-full h-96 grid place-items-center relative">
			<div className="max-w-[1000px] w-full h-full grid place-items-center">
				...
				<motion.h1 className="text-6xl max-w-3xl text-center text-white font-semibold absolute">
					A catalyst to increase your productivity by ~5x.
				</motion.h1>

				<div className="w-full max-w-[1000px] h-20 bg-bg absolute -bottom-[86px] border-t border-t-purple-purple12" />
			</div>
		</div>
	);
};
